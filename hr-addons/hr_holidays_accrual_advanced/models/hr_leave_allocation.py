...
class HrLeaveAllocation(models.Model):
    ...
    def _prepare_holiday_values(self, employee):
        """ add more values to be used while creating new allocations """
        self.ensure_one()
        res = super()._prepare_holiday_values(employee)
        values = {
    ...
    def create(self, values):
        accrual = values.get('allocation_type', 'regular')
    ...
    def _update_accrual_allocation(self):
        ...
        if self.allocation_type == 'regular':  # pragma: no cover
    ...
    def _get_worked_days(self, from_datetime, to_datetime):
        ...
        calendar = self.resource_calendar_id or \
    ...
    def _get_workable_days(self, from_datetime, to_datetime):
        ...
        calendar = self.resource_calendar_id or \
                   self.employee_id.resource_calendar_id
        return self.employee_id._get_work_days_data(
            from_datetime,
            to_datetime,
