...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fqueue-lightgray.png?logo=github
    :target: https://github.com/OCA/queue/list/16.0/queue_job
    :alt: OCA/queue
...
This module is part of the `OCA/queue <https://github.com/OCA/queue/list/16.0/queue_job>`_ project on GitHub.
