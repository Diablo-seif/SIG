...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fserver--backend-lightgray.png?logo=github
    :target: https://github.com/OCA/server-backend/list/16.0/base_user_role
...
This module is part of the `OCA/server-backend <https://github.com/OCA/server-backend/list/16.0/base_user_role>`_ project on GitHub.
