...
# pylint: disable=no-member, protected-access, access-member-before-definition
# pylint: disable=attribute-defined-outside-init, inconsistent-return-statements
class AccountMoveLine(models.Model):
    ...
    def _onchange_product_id(self):
        ...
        for line in self:
            ...
            # However, mapping a price-included tax to another price-included
            # tax must preserve the balance but
            # adapt the price_unit to the new tax.
            # E.g. mapping a 10% price-included tax to a 20% price-included
            # tax for a price_unit of 110 should preserve
            ...
            if line.tax_ids and line.move_id.fiscal_position_id:
                ...
                line.price_unit = line._get_fields_onchange_balance(
                    amount_currency=balance).get('price_unit', line.price_unit)
    ...
    def _onchange_account_id(self):
        ...
        """
        if not self.display_type and (
                self.account_id.tax_ids or not self.tax_ids):
